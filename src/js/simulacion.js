...
function generarResultados() {
  ...
  let compra =
    toneladasAluminio < 2500
      ? `<p>Se comprarán dos nuevos camiones recolectores para aumentar la capacidad de recolección de basura.</p><img src="src/img/camionNuevo.webp" alt="camion nuevo">`
      : `<p>Se adquirirá una nueva máquina trituradora para aumentar la capacidad de trituración de aluminio.</p><img src="src/img/trituradora.webp" alt="trituradora nueva">
`;
  let demandaEssen =
  ...
  let ctx2 = document.getElementById("graficoBasuraAluminio").getContext("2d");
